...
define("TITLE_AUTO_GEN_ORDER_ID", "Auto-generate Order IDs");
define("LABEL_AUTO_GEN_ORDER_ID", "Use unique order IDs generated by goEmerchant instead of WooCommerce order numbers.");
    ...
    public function process_payment($order_id) {
        ...
        if ($useSavedCard) {
            ...
            if (!$this->get_cc() || $this->is_cvv_blank()) {
                ...
                if (!mod10Check($cardInfo['cardNumber'])) {
        ...
        if ($rgw->Result['isSuccess'] == 1) {
            ...
            wc_add_notice("There was a problem processing your order. Please try again later.", "error");
            return;
        }
    }
